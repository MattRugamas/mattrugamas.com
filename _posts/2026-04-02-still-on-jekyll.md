...
**The case against React (for this)**

I want to be careful here. I work with React every day — debugging it, reading through it, explaining it. I have nothing against it. But when I think about what I'd be adding to this site by reaching for it, I mostly come up with a list of new problems:
...
There's a reason the people I find most interesting online tend to have personal sites. The act of maintaining one — even a simple one, especially a simple one — is a small signal that someone thinks their thoughts are worth putting somewhere permanent.
...
So: still on Jekyll. Probably forever — or at least until GitHub Pages does something unforgivable, which seems unlikely. And if they do, the files are right here.
